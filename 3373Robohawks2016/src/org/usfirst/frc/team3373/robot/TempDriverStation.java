 ...
 * Station.
 */
public class TempDriverStation implements RobotState.Interface {
  ...
  private static class DriverStationTask implements Runnable {
    ...
    private TempDriverStation m_ds;

    DriverStationTask(TempDriverStation ds) {
      m_ds = ds;
    }
  ...
  private static TempDriverStation instance = new TempDriverStation();

  private Object[][] recordedAxes = new Object[500][kJoystickPorts];
  private Object[][] recordedPOVs = new Object[500][kJoystickPorts];
  private Object[][] recordedButtons= new Object[500][kJoystickPorts];
   ...
   */
  public static TempDriverStation getInstance() {
    return TempDriverStation.instance;
  }
  ...
  private void task() {
    ...
    while (m_thread_keepalive) {
      ...
      synchronized (this) {
    	if(gloopCounter>499 && gloopCounter<999){
    		getRecordedData(gloopCounter-500);
    	}else{
    		getData();
    	}
      }
  ...
  protected synchronized void getData() {
    ...
    for (byte stick = 0; stick < kJoystickPorts; stick++) {
      ...
      recordedAxes[gloopCounter][stick] = m_joystickAxes[stick];
      m_joystickPOVs[stick] = FRCNetworkCommunicationsLibrary.HALGetJoystickPOVs(stick);
      recordedPOVs[gloopCounter][stick] = m_joystickPOVs[stick];
      ...
      recordedButtons[gloopCounter][stick] = m_joystickButtons[stick];
      System.out.println("Recording" + gloopCounter);
    }

    m_newControlData = true;
  }
  protected synchronized void getRecordedData(int loopCounter) {

	    // Get the status of all of the joysticks
	    for (byte stick = 0; stick < kJoystickPorts; stick++) {
	      m_joystickAxes[stick] = (short[]) recordedAxes[loopCounter][stick];
	      m_joystickPOVs[stick] = (short[])  recordedPOVs[loopCounter][stick];
	      m_joystickButtons[stick] = (TempDriverStation.HALJoystickButtons) recordedButtons[loopCounter][stick];
	      System.out.println("Playing back" + loopCounter);
	    }
